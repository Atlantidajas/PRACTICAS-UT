...
Direccion: contiene los campos de la tabla relacionados con la dirección de la persona. Debe contener los atributos:
...
Crear los métodos getter(), setter() y los constructores que sean necesarios para las clases Direccion, Persona y Lista.
...
buscar(int DNI): busca una persona por el DNI, si la encuentra, devuelve el objeto de tipo Persona con la información de esa persona, si no lo encuentra devolverá null.
