...
Opcional: Implementar el método calculaDescuento() utilizando polimorfismo y definiéndolo de manera abstracta en la clase Persona, para obligar a todas las clases que heredan de la clase Persona a definirlo.
 * 
		...
		do {
			...
			switch(opcion) {//<-- switch main
				...
				case 1:
					...
					System.out.println("Introduzca precio artículo");		
